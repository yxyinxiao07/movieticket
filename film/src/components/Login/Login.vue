...
<script>
    import {getPhoneCode,phoneLogin,pwdLogin,getUserInfo} from '../../api/index'
            ...
            if (this.loginType){
              ...
              if (this.phone===''){
                ...
                if (json.success_code===200){
                  ...
                  let jsonData = await getUserInfo(this.$cookies.get('user_id'));
              ...
              if (this.userName===''){
                ...
                let json = await pwdLogin(this.userName,md5(this.password),this.captcha);
                if (json.success_code===200){
                  Toast({
                    message: '登录成功',
                    position: 'middle',
