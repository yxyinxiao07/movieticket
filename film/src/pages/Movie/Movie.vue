<template>
    <div id="movie">
      ...
      <div class="tab-content" ref='container'>
        <div class="panel" v-show="isHotMovie" ref="noHotMovie">
          <movie-item :movie-list="hotMovieList"></movie-item>
        </div>
        <div class="panel" v-show="!isHotMovie" ref="noMovie">
        ...
        async loadMovieList(){
          ...
          if (json.data) {
            ...
            if (this.hotMovieList.length == 0) {
              this.$refs.noHotMovie.innerHTML = '暂无数据，待增加';
            };
            if (this.notShowMovieList.length == 0) {
              this.$refs.noMovie.innerHTML = '暂无数据，待增加';
            };
