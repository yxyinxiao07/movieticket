...
//补齐信息用户名密码
export const updateUser = (userId, userName, userPwd) => ajax('/api/updateUser', { userId, userName, userPwd }, 'POST');
//账号密码登录
...
//更新用户名
export const updateUserPhone = (userId, userPhone) => ajax('/api/updateUserPhone', { userId, userPhone }, 'POST');
//更新手机号
export const updateUserName = (userId, userName) => ajax('/api/updateUserName', { userId, userName }, 'POST');
//更新密码
export const updateUserPwd = (userId, userPwd) => ajax('/api/updateUserPwd', { userId, userPwd }, 'POST');
//更新用户性别
...
//获取电影列表
export const getMovieList = (city) => ajax('/api/getMovieList', {city});
//获取电影详情
...
//获取电影列表
export const getCinemaList = (city)=>ajax('/api/getCinemaList',{city});
...
//根据名字模糊匹配影院
export const matchCinemaByName = (cinemaName,city)=>ajax('/api/matchCinemaByName',{cinemaName,city});
//用户下单
...
//退票
export const cancelOrder = (orderId, scheduleId, orderSeatInfo) => ajax('/api/cancelOrder', { orderId, scheduleId, orderSeatInfo }, 'POST');
//获取个人想看电影
