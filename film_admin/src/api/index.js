...
//注册
export const regist = (name, password, sex, phone, birthday, avatar) => ajax('/api/admin/regist', { name, password, sex, phone, birthday, avatar }, 'POST');
//登录
...
//更新影院信息
export const updateCinemaInfo = (cinemaId, cinemaName, cinemaPhone, province, city, address) => ajax('/api/admin/updateCinemaInfo', { cinemaId, cinemaName, cinemaPhone,province,city,address},'POST');
//删除影院信息
export const deleteCinemaInfo = (cinemaId)=>ajax('/api/admin/deleteCinemaInfo',{cinemaId},'POST');
//添加影院信息
export const addCinemaInfo = (cinemaName, cinemaPhone, province, city, address) => ajax('/api/admin/addCinemaInfo', { cinemaName, cinemaPhone, province, city,address},'POST');
//获取当前页用户评论
